...
export default {
  title: 'Components/Controls/CurrencyInput',
  component: 'Card',
  parameters: {
    options: {
      showPanel: true,
...
export const Showcase = {
  render: (args: Args) => ({
    template: hbs`<CurrencyInput @value={{this.value}} @update={{this.update}} @disabled={{this.disabled}} placeholder={{this.placeholder}}/>`,
    context: {
      ...parseArgs(args),
