...
import { CurrencyInput, type CurrencyInputSignature } from './currency-input.gts';

import type { Meta, StoryObj } from 'ember-storybook';

export default {
  title: 'Controls/CurrencyInput',
...
type Args = CurrencyInputSignature['Args'] & { disabled?: boolean | string };
