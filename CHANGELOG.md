...
#### :bug: Bug Fix
* `@hokulea/ember`
  * [#458](https://github.com/hokulea/hokulea/pull/458) Allow HTML attributes on `<Avatar>` ([@gossi](https://github.com/gossi))
...
* `@hokulea/ember`, `@hokulea/core`, `@hokulea/tokens`, `@hokulea/theme-moana`
  * [#366](https://github.com/hokulea/hokulea/pull/366) Repository URL ([@gossi](https://github.com/gossi))
  * [#335](https://github.com/hokulea/hokulea/pull/335) Prepare Release ([@github-actions[bot]](https://github.com/apps/github-actions))
...
@hokulea/core 0.3.2 (patch)

#### :bug: Bug Fix
* `@hokulea/ember`, `@hokulea/ember-test-app`, `@hokulea/core`
  * [#334](https://github.com/hokulea/hokulea/pull/334) Fix tabs: `@selection` and padding ([@gossi](https://github.com/gossi))
